...
module.exports = {
	...
	/**
	 * used in `htmlspecialchars`,`htmlspecialchars_decode`,`htmlentities`,`get_html_translation_table`, `htmlentities`, `html_entity_decode`
	 * 
	...
	// used in `get_html_translation_table`
	HTML_SPECIALCHARS : 0,
	HTML_ENTITIES     : 1,
