/** 
 * Javascript equivalent to php `natcasesort`
 * 
 * Sort an array using a case insensitive "natural order" algorithm
 * @see https://www.php.net/manual/en/function.natcasesort.php
 * 
 * [Note]
 * This Javascript function of `natsort` is the same sa `sort` with `SORT_REGULAR`, `SORT_NATURAL` and `SORT_FLAG_CASE`.
 *  
 * @param array &array
 * @return bool
 */
...
const natcasesort = (ar)=>{
	const flags = SORT_REGULAR | SORT_NATURAL | SORT_FLAG_CASE;
