/** 
 * Javascript equivalent to php `rtrim`
 * 
 * Strip whitespace (or other characters) from the end of a string
 * @see https://www.php.net/manual/en/function.rtrim.php
 * 
 * [Node]
 * If you want to just remove whitespaces, you can also use `String.prototype.trimEnd()` or `trimRight()`.
