/** 
 * Javascript equivalent to php `natsort`
 * 
 * Sort an array using a "natural order" algorithm
 * @see https://www.php.net/manual/en/function.natsort.php
 * 
 * [Note]
 * This Javascript function of `natsort` is the same sa `sort` with `SORT_REGULAR` and `SORT_NATURAL`.
 *  
 * @param array &array
 * @return bool
 */
...
const natsort = (ar)=>{
	const flags = SORT_REGULAR | SORT_NATURAL;
